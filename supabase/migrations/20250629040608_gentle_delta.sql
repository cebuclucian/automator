...
CREATE POLICY IF NOT EXISTS "Users can view their own course materials"
ON storage.objects
FOR SELECT
TO authenticated
USING (
...
CREATE POLICY IF NOT EXISTS "Users can upload their own course materials"
ON storage.objects
FOR INSERT
TO authenticated
WITH CHECK (
...
CREATE POLICY IF NOT EXISTS "Service role can manage all course materials"
ON storage.objects
FOR ALL
TO service_role
