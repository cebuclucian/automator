...
-- Create ENUM types with IF NOT EXISTS to prevent conflicts
CREATE TYPE IF NOT EXISTS plan_type AS ENUM ('free', 'basic', 'pro', 'enterprise');
...
BEGIN
  ...
  -- Drop policies for materials table
