/*
  # Initial Database Schema - Complete Setup

  1. New Tables
    - `users` - User profiles linked to auth.users
    - `jobs` - Course generation jobs with progress tracking
    - `materials` - Generated course materials with download links
...
CREATE INDEX idx_materials_storage_path ON materials(storage_path);
